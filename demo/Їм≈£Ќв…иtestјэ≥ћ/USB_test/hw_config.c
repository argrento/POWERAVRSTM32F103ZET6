...
#define JOY_DOWN     GPIO_Pin_13 /* PC.13 */
#define JOY_LEFT     GPIO_Pin_8  /* PA.08 */
#define JOY_RIGHT    GPIO_Pin_3  /* PD.03 */
...
void Set_System(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD |RCC_APB2Periph_GPIOB| RCC_APB2Periph_GPIOA| RCC_APB2Periph_GPIOC, ENABLE);
  
  /* PB.05 used as USB pull-up */
  ...
  /* Key up + Key down  */	   
  /* Key left + Key right */
  GPIO_InitStructure.GPIO_Pin = JOY_UP | JOY_LEFT;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
  GPIO_Init(GPIOA, &GPIO_InitStructure);

  GPIO_InitStructure.GPIO_Pin =  JOY_RIGHT;
  GPIO_Init(GPIOD, &GPIO_InitStructure);
  GPIO_InitStructure.GPIO_Pin =  JOY_DOWN ;
...
u8 JoyState(void)
{
  ...
  /* "left" key is pressed */
  if (!GPIO_ReadInputDataBit(GPIOA, JOY_LEFT))
  {
    return LEFT;
  }
  /* "up" key is pressed */
