...
/*******************************************************************************
* Print int data to LCD display                                                *
*   Parameter:     v: a int  data to be dispayed                               *
*   Return:                                                                    *
*******************************************************************************/

void lcd_putint(int v){
   int t1=v&0xF;
   int t2=(v&0xF0)>>4;
   int t3=(v&0xF00)>>8;
   int t4=(v&0xF000)>>12;
   lcd_print ("0X");
   lcd_putchar (value[t4]);
   lcd_putchar (value[t3]);
   lcd_putchar (value[t2]);
   lcd_putchar (value[t1]);
